 ...
 *
 * Serves a real {@see Feed} through {@see Feed::serve()} exactly as an HTTP
 * route would, so a consumer reading it exercises the whole contract —
